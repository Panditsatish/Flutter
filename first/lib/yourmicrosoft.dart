...
class _MyAppState extends State<YourApp> {
  ...
  _fetchMicrosoftProfile() async {
    var response = await http.get(Uri.parse(this._graphURI), headers: {
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                TextButton( onPressed: _acquireTokenInteractively,
                    child: Text('Acquire Token'),),
                  TextButton( onPressed: _acquireTokenSilently,
                      child: Text('Acquire Token Silently')),
                  TextButton( onPressed: _signOut,
                      child: Text('Sign Out')),
                  TextButton( onPressed: _fetchMicrosoftProfile,
                      child: Text('Fetch Profile')),
                  if (Platform.isAndroid == true)
                    TextButton( onPressed: _loadAccount,
